...
import com.game.forcesofnature.level2.LevelTwoActivity;
...
//        private float[] mRedObstacleRadii;
		...
		private void initialiseVariables(){
	        ...
	        mRedObstacleXVariation[0] = 0f;
	        mRedObstacleXVariation[1] = 0f;
	        mRedObstacleXVariation[2] = 0f;
	        mRedObstacleXVariation[3] = 0f;
	        mRedObstacleXVariation[4] = 0f;
	        mRedObstacleXVariation[5] = 0f;
		...
		private void setWinningDialogBox() {
			...
			builder.setMessage(R.string.winning_dialog_message1);
